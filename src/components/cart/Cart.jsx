...
export const Cart = () => {
  ...
  return (
    <div className="lg:px-14 sm:px-8 px-4 py-10">
      ...
      <div class="grid md:grid-cols-5 grid-cols-4 gap-4 pb-2 font-semibold items-center">
      ...
      <div className="border-t-[1.5px] border-slate-200 py-4 flex sm:flex-row sm:px-0 px-2 flex-col sm:justify-between gap-4">
        ...
        <div className="flex text-sm gap-1 flex-col">
          ...
          <p className="to-slate-500">
            Taxes and shipping calculated at checkout
          </p>
          <Link className="w-full flex justify-end" to={"/checkout"}>
            <button
              onClick={() => {}}
              className="cursor-pointer font-semibold w-[300px] py-2 px-4 rounded-sm bg-custom-blue text-white flex items-center justify-center gap-2 hover:text-gray-300 transition duration-500"
            >
              <MdShoppingCart />
              Checkout
            </button>
