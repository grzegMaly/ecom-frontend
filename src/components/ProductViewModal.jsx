          ...
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              <div className="px-6 pt-10 pb-2">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    {specialPrice ? (
                      <div className="flex items-center gap-2">
                        <span className="to-gray-400 line-through">
                ...
                <div className="ppx-6 py-4 flex justify-end gap-4">
                  <button
                    type="button"
                    onClick={() => setOpen(false)}
                    className="border-1 cursor-pointer px-4 py-2 text-sm font-semibold text-slate-700 hover:text-slate-800 hover:border-slate-800 rounded-md"
                  >
                    Close
                  </button>
                </div>
